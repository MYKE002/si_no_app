...
import 'package:si_no_app/presentacion/widgets/my_message_buble.dart';
import 'package:si_no_app/presentacion/widgets/otros_message_buble.dart';
        ...
        leading: const Padding(
          ...
          child: CircleAvatar(
            backgroundImage: NetworkImage(
              'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQYrXJbwhwO94iECP0qUzvI3aTU55n4PLRSqQ&s',
            ),
          ),
        ),
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return (message.yooEl == YooEl.hers)
                      ? OtrosMessageBuble(message: message)
